			...
			<div class="priv">
				...
				<div class="history">
					...
					<ul>
						...
						<li><a href="4.php"style="font-weight: 700;text-decoration: underline;">Способы работы с клиентами</a><img src="images/ok.png"></li>
...
<img src="images/1.png">
			...
			<div class="stud">
				<div class="vid">
					<video controls>
					  <source src="/IMG_5162.mov" type="video/mp4">
					  Your browser does not support the video tag.
					</video>
				</div>
				<div class="studing">
					<h1>Способы работы с клиентами</h1>
					</div>
			</div>
		</main>
