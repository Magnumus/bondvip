      ...
      <div class="priv">
        ...
        <div class="history">
          ...
          <ul>
            ...
            <li><a href="2.php"style="font-weight: 700;text-decoration: underline;">Типы продвижения</a><img src="images/ok.png"></li>
...
<img src="images/1.png">
			...
			<div class="stud">
				<div class="vid">
          <video controls>
					  <source src="IMG_5161.mov" type="video/mp4">
					  Your browser does not support the video tag.
					</video>
				</div>
				<div class="studing">
					<h1>Типы продвижения</h1>
					<p>Существует два типа продвижения в Instagram:<br><br>
• SMM для личного бренда <br>
• SMM для продаж <br>
<br>
</p>
				</div>
