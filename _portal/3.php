			...
			<div class="priv">
				...
				<div class="history">
					...
					<ul>
						...
						<li><a href="3.php"style="font-weight: 700;text-decoration: underline;">Таргетированная реклама</a><img src="images/ok.png"></li>
...
<img src="images/1.png">
			...
			<div class="stud">
				...
				<div class="studing">
					...
					<p> Настройка таргета в Instagram:<br><br>
• Таргет на своих подписчиков<br>
• Таргет на свою ЦА<br>
• Таргет на продажи<br><br>
Дополнительно: <br>
<a href="http://komysov.ru/vovlechennost">Ссылка по настройке таргета на своих подписчиков<br></a>
<br>
</p>
